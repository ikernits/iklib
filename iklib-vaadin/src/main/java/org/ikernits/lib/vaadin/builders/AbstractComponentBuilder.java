...
import org.ikernits.lib.vaadin.VaadinComponentBuilder;
...
public class AbstractComponentBuilder<T extends AbstractComponent, B extends AbstractComponentBuilder<T, B>> extends VaadinComponentBuilder<T, B> {
