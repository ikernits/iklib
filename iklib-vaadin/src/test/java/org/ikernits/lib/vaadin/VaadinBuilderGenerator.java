...
class VaadinBuilderGenerator {
    ...
    private static class ComponentModel {
        ...
        public void print(IndentedPrinter out) {
            ...
            if (clazz.equals(AbstractComponent.class)) {
                superName = "VaadinComponentBuilder";
                imports.add(VaadinComponentBuilder.class.getName());
            } else {
    ...
    private static final String targetPackage = VaadinComponentBuilder.class.getPackage().getName() + ".builders";
